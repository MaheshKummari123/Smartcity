		...
		<div class="container">
			...
			<div class="collapse navbar-collapse">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item"><a class="nav-link" href="studentDashboard">Home</a></li>
					...
					<li class="nav-item"><a
						class="nav-link btn btn-danger text-white ms-2" href="logout">Logout</a>
					</li>
				</ul>
			</div>
		</div>
		...
		<div class="card shadow table-card p-4">
			...
			<table class="table table-hover align-middle">
				...
				<tbody>
					...
					%>
					<tr>
						<td colspan="5" class="text-center text-danger fw-bold">You
							have Zero Applications</td>
					</tr>
