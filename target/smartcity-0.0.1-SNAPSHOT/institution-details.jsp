<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"
	import="com.smartcity.model.Institutions,java.util.List"%>
...
<body>
	...
	<div class="container my-5">
		...
		<!-- Back Button -->
		<a href="student-dashboard.jsp" class="btn btn-secondary mb-3">← Back
			to Attractions</a>

		<!-- Main Card -->
		<div class="card shadow">
			<%Institutions insti=(Institutions)session.getAttribute("insti"); 
			if(insti!=null){	
			%>
			<!-- Large Image -->
<%-- 			<img src="<%=tourist.getImageUrl() %>"
			...
			<div class="card-body">
				...
				<div class="d-flex justify-content-between align-items-center">
					<h2 class="fw-bold"><%=insti.getName() %></h2>
					<span class="badge bg-primary"><%=insti.getInstituitionType() %></span>
				</div>
				...
				<div class="row mt-4">
					...
					<div class="col-md-6">
						<div class="section-box mb-3">
							<h6>📍 Address</h6>
							<p><%=insti.getAddress() %></p>
						</div>

						<div class="section-box mb-3">
							<h6>🎓 Courses Offer</h6>
							<p><%=insti.getCourseOffer() %></p>
						</div>

						<div class="section-box mb-3">
							<h6>📧 Email</h6>
							<%=insti.getContactEmail() %></p>
						</div>
						
						<div class="section-box mb-3">
							<h6>📞 Contact Phone</h6>
							<%=insti.getContactPhone() %></p>
						</div>
						
						<div class="section-box mb-3">
							<h6> Website</h6>
							<a href="<%=insti.getWebsite() %>" target="_blank"><%=insti.getWebsite() %></a>
						</div>
					...
					<div class="col-md-6">
						<div class="section-box">
							<h6>📌 Location Map</h6>
							<iframe
								src="https://maps.google.com/maps?q=<%=insti.getAddress() %>&output=embed"
