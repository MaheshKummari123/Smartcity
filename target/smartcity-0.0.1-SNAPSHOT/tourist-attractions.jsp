...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item"><a class="nav-link" href="tourist-dashboard.jsp">Home</a></li>
					<li class="nav-item"><a class="nav-link active" href="#">Attractions</a></li>
					<li class="nav-item"><a class="nav-link" href="tourist-hotels.jsp">Hotels</a></li>
					<li class="nav-item"><a class="nav-link" href="#">Events</a></li>
					<li class="nav-item"><a
						class="nav-link btn btn-danger text-white ms-2" href="#">Logout</a></li>
				</ul>
			</div>
		</div>
	</nav>
	...
	<div class="container my-5">
		<h2 class="text-center fw-bold mb-4">Attractions</h2>
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form action="touristDetails" method="get">
                    	<input type="hidden" value="tourist-attractions.jsp" name="source">
	...
	<!-- 🔹 Footer -->
	<footer class="py-4 text-center"> © 2026 SmartCity Tourism
		Portal </footer>
