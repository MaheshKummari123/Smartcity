            ...
            <div class="scrolling-tabs">
                ...
                <form action="register" method="get">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrap">
                            <span class="input-icon"><svg width="14" height="14" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2">
                                    <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />
                                    <circle cx="12" cy="7" r="4" />
                                </svg></span>
                            <input type="text" placeholder="Arjun" name="fullName">
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="email" placeholder="arjun@smartcity.gov.in" name="email">
                    </div>
                </div>
                ...
                <div class="form-group">
                        ...
                        <div class="input-wrap">
                            ...
                            <input type="text" placeholder="Kumar" name="username">
                        </div>
                    </div>
                ...
                <div class="form-group">
                    <label class="form-label">Citizen Role</label>
                    <div class="input-wrap">
                        <span class="input-icon"><svg width="14" height="14" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="password" id="regPwd" placeholder="Min. 8 characters"
                            oninput="checkStrength(this.value)" name="password">
                        <span class="input-icon-right" onclick="togglePwd('regPwd','eyeReg')">
                            <svg id="eyeReg" width="14" height="14" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2">
                ...
                <div class="terms-row">
                    ...
                    <span class="custom-checkbox" id="cbVis2" onclick="toggleCheck('cb2','cbVis2')"
                        style="cursor:pointer;margin-top:2px;flex-shrink:0;"></span>
                    <span>I agree to the <span class="terms-link">Terms of Service</span> and <span
                            class="terms-link">Privacy Policy</span> of SmartCity Portal</span>
                </div>
                ...
                <div class="form-footer">
    				<button class="btn-primary">Create My Account</button>
