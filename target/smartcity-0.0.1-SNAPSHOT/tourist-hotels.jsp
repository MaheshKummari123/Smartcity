...
<body>
    ...
    <div class="container my-5">
        <h2 class="text-center fw-bold mb-4">Hotels</h2>
            ...
            <div class="col-md-4">
                ...
                <img src="<%=hotel.getImageUrl() %>" class="card-img-top" height="220">
                    <div class="card-body">
                        ...
                        <input type="hidden" value="tourist-hotels.jsp" name="source">
                    	<input type="hidden" value="<%=hotel.getAttractionId() %>" name="id">
